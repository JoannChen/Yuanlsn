...
import com.zuoyu.yuanlsn.application.Constant;
import com.zuoyu.yuanlsn.utils.http.HMAC;
import com.zuoyu.yuanlsn.utils.http.HttpResult;
    ...
    private Map<String, String> getHeader(String urlParams) {
        ...
        try {
            ...
            byte[] data = HMAC.encodeHmacSHA256(
                    builderAppend.getBytes(), (ToolUtil.isEmpty(token) ? Constant.INSTANCE
                            .getPROJECT_KEY().getBytes() : token.getBytes()));
            ...
            header.put("Projectid", Constant.INSTANCE.getPROJECT_ID());
