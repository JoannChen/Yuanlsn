...
public class ToolUtil {
    ...
    public static boolean isNetConnection() {
        ConnectivityManager connManager = (ConnectivityManager) MyApplication.Companion.getInstance()
...
/*    public static void callPhone(Context context, String tel) {
    ...
    public static String getVersionName() {
        try {
            // 获取packageManager的实例
            PackageManager packageManager = MyApplication.Companion.getInstance().getPackageManager();
            // getPackageName()是你当前类的包名，0代表是获取版本信息
            PackageInfo packInfo = packageManager.getPackageInfo(MyApplication.Companion.getInstance().getPackageName(), 0);
